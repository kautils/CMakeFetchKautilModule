    ...
    if(${${m}_force_build}
        ...
        if(EXISTS ${${prfx}}/CMakeLists.txt)
            ...
            if(DEFINED ${m}_cmake_configure)
                CMakeExecuteCommand(execgit ASSERT ${${m}_verbose_option} DIR "${${m}_build_root}" COMMAND cmake -S . -B "${__str_build_dir}" ${${m}_cmake_configure} ${${m}_cmake_macro})  
            else()
            ...
            list(APPEND ${prfx}_buf_list ${${prfx}.VARS} ${prfx}.BUILD_DIR ${prfx}.CLONE_PREFIX ${prfx}.INSTALL_PREFIX)
            list(REMOVE_DUPLICATES ${prfx}_buf_list)
            set(${prfx}.BUILD_DIR "${__str_build_dir}" CACHE STRING "last cloned dir" FORCE)
            ...
            set(${prfx}.VARS "${${prfx}_buf_list}" CACHE STRING "variables struct ${prfx} has." FORCE)
